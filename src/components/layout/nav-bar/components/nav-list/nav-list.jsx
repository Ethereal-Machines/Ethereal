...
const navList = (props) => {
  ...
  return (
    <ul className="nav-list">
      ...
      {/* <NavItem linkType={'text'} navLink={true} address={'/designfiles'} name={'Design Files'} {...props}/> */}
      <NavItem linkType={'text'} navLink={true} address={'/covid'} name={'Covid-19 efforts'} {...props}/>
