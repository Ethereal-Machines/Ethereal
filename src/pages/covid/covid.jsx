...
import getCovid from '../../services/api/get-covid';
...
import CovidForm from './components/covid-form/covid-form';
...
class Covid extends Component {
  ...
  onGetCovid = () => {
         ...
         },
    {
      ...
      this.props.onUpdateCovidItems(data1);
